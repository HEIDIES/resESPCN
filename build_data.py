...
def data_reader(train_input_dir, shuffle=True):
...
def _convert_to_example(train_data):
...
def data_writer(train_input_dir, output_file):
    ...
    """
    train_file_paths = data_reader(train_input_dir)
    ...
    for i in range(images_num):
        ...
        example = _convert_to_example(train_data)
